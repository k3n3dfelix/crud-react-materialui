...
const create = async (
  ...
  try {
    ...
    console.error(error);
    return new Error(
      (error as { message: string }).message || 'Erro ao criar os registro.'
    );
  }
};
...
const updateById = async (
  ...
  try {
    ...
    console.error(error);
    return new Error(
      (error as { message: string }).message || 'Erro ao atualizar os registro.'
    );
  }
};
...
const deleteById = async (  id: number): Promise<void | Error> => {
  try {
    ...
    console.error(error);
    return new Error(
      (error as { message: string }).message || 'Erro ao apagar os registro.'
    );
  }
};
